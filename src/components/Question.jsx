...
function Question() {
  ...
  const trends = ['Why is my Louise Simony the sweetest most beautiful girl?', 'Where will my love and I be in 50 years? (Hopefully old and wrinkly together)', `The day Louise Simony and Josy met`,]
